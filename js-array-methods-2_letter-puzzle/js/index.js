...
const everyEmployeeHasPhoneNumber = employees.every((employee) =>
...
const employeeLouise33 = employees.find((employee) => {
  return employee.firstName === "Louise" && employee.age === 33;
});
